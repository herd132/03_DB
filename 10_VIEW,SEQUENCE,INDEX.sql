...
-- V_DCOPY2 VIRE를 이용해서 INSERT 수행
INSERT INTO V_DCOPY2 
VALUES('D0' , 'L2');
--> 가상 테이블 VIEW 인데 INSERT 가 성공함!
...
-- 반대로 사용되지 않은 컬럼(DEPT_TITLE)에는 NULL 이 들어감!
...
WHERE TEST_ID = 'TEST500000'; -- 0.013s

/* 인덱스 O */
-- TEST_NO 가 500000인 행을 조회하기
SELECT * FROM TB_IDX_TEST
